        ...
        <div className="flex flex-col bg-base-100 rounded-3xl items-center p-8 space-y-4">
          ...
          <div className="text-white space-y-4">
            <div className="space-y-2">
              ...
              <input type="text" placeholder="Type Here" className="input input-bordered input-accent w-full max-w-xs" value={addData.kode_aslab} onChange={(e) => setAddData({ ...addData, kode_aslab: e.target.value })} />
            </div>
            <div className="space-y-2">
